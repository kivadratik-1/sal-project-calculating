...
for it in trass_massive:
    L = it[1]
    #print('Трасса '+str(it[0])+' длинной '+str(it[1])+'м ')
    ...
    for i in temp_list:
        print( 'Трасса '+str(it[0])+' длинной '+str(it[1])+'м ', '|', toFixed(( H_z - float(Provis(L_ot_T(i)))), 2) , '|', toFixed(Nagruzka_ot_dlini(Provis(L_ot_T(i)), L), 2) )
